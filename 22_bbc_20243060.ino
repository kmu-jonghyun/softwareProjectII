...
#define _DUTY_NEU 1800 // 1600
#define _DUTY_MIN 750 // 1000

#define _SERVO_ANGLE_DIFF  26  // Replace with |D - E| degree
...
void loop()
{
  ...
  if (event_dist) {
    ...
    if (dist_ema > _DIST_TARGET) {
      ...
      duty_target = _DUTY_NEU + _BANGBANG_RANGE-200;
...
float volt_to_distance(int a_value)
{
  ...
  return  629 + -2.04*a_value + 1.69E-03*a_value*a_value;
}
